 ...
 * Section definitions come from tools/importer/page-templates.json (template "home").
 * All section.selector entries verified against migration-work/cleaned.html.
 *
 * Inserts <hr> breaks in beforeTransform (while every section element still
 * exists, before block parsers can replace them), and Section Metadata blocks
 * in afterTransform for any styled section. None of the WKND home sections have
 * a style, so only section breaks are produced (expected count = sections - 1).
 */
